...
// Login routes, before admin routes since they must be able to access without being logged in
app.get('/admin/login', routes.admin.login);
app.post('/admin/login', passport.authenticate('local'), controllers.auth.localDone);

// Admin routes
app.all('/admin*', controllers.auth.mustBeLoggedIn(2));
app.get('/admin', routes.admin);

app.get('/admin/posts/create', routes.admin.posts.create);
app.post('/admin/posts/create', routes.admin.posts.publish);
app.get('/admin/posts/edit/:id', routes.admin.posts.edit);
app.post('/admin/posts/edit/:id', routes.admin.posts.publish);
