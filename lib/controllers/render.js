...
exports.resolveViewPath = function (callback) {
  ...
  //## In the past, and possibly in the future, more logic was needed here. Clean
  //## up if it in a few months seem to be not needed (when a working admin and
  //## admin theme api has been figured out) // 2013-05-09
  if(view.shift() === 'theme') {
    view.unshift('themes');
  }
