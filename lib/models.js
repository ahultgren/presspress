 ...
 * User
 *
 * Model for every registered user, admin or 
 */
...
User.method('auth', function(plainText) {
  return (this.activated && this.encryptPassword(plainText) === this.hashed_password);
});
